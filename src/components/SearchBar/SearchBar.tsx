...
const SearchBar = ({ onNewCity }: SearchBarProps) => {
  ...
  return (
    <form className="content-options" onSubmit={ onSubmit } data-testid="search-form">
      <button type="submit" aria-label="Search">
        <svg className="icon" height="16" stroke="#fff" strokeWidth="20" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <input
        ...
        onChange={ onChange }
      />
      <button type="button" aria-label="Location" onClick={ getCurrentPosition }>
        <svg className="icon" height="16" stroke="#fff" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
